...
## Requirements 
1. A Google account
2. Access to Google services such as Google Apps Script
...
6. Create a new file using the **+** button and name it **index** and clear its default contents
7. Open the **index.html** from this project and copy all its contents into the online editor of the new file you created
...
14. You'll receive Web App URL; open the URL and use it or copy/bookmark it to use whenever you want.

## Usage
1. Enter or paste a link to a file
2. Enter an optional name if needed. Original file name will be used as default.
3. Enter ID of the folder which you want to save the file there. As default the file will be saved in the **GDRemoteUpload** folder in the root of your drive.
...
6. If the file size goes more than 50 MB, the file will be splitted in parts. In this case you will receive the folder link that contains the file parts. You download all parts (or the whole folder) and then use the **FileJoiner.bat** to join the parts and receive the main file.
